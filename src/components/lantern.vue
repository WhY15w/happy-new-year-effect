<template>
  <div class="pointer-events-none fixed inset-x-0 top-2.5 z-9999 opacity-80">
    ...
    >
      ...
      >
        <!-- 悬挂线 -->
        <div class="absolute -top-6 left-1/2 h-6 w-0.5 -translate-x-1/2 bg-amber-500" />
        ...
        >
          ...
          >
            <span
              class="bg-linear-to-b from-amber-200 to-amber-500 bg-clip-text text-[2.6rem] font-bold text-transparent drop-shadow-md md:text-[3rem]"
            >
              {{ text }}
            </span>
          </div>
        ...
        >
          ...
          />
          <div class="absolute top-4 left-1/2 h-3 w-3 -translate-x-1/2 rounded-full bg-amber-400" />
        </div>
